...
// Master service should ping servers and remove if they are down
// Client should be able to accept console input and do a query
// Servers should pass message through the chain using ACKNOWLEDGEMENT as specified in paper
// Servers should update requests and pass updated state
// Servers should be added to the end of the chain and updated